...
public class PlayerPatch
{
    ...
    private static void Player_Update(On.Player.orig_Update orig, Player self)
    {
        ...
        {
            KeepCameraAfterDeath.Logger.LogInfo("CAD-MOD: try add reward");
            AddCashToRoom();
            AddMCToPlayers();
        ...
        void AddCashToRoom()
        {
            ...
            KeepCameraAfterDeath.Logger.LogInfo("CAD-MOD: pending cash reward: $"+ hostSpecifiedCashReward);
        ...
        void AddMCToPlayers()
        {
            ...
            KeepCameraAfterDeath.Logger.LogInfo("CAD-MOD: pending mc reward: " + hostSpecifiedMCReward+ "MC");
